...
if __name__ == "__main__":
    csv_file_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "stocks_data.csv")
    output_file_path = os.path.join(os.path.dirname(csv_file_path), "average_daily_return.csv")
